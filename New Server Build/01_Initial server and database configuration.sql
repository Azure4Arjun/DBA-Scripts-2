...
EXEC sp_configure 'max degree of parallelism',5;RECONFIGURE;  -- If required
EXEC sp_configure 'max server memory (MB)',20000;RECONFIGURE WITH OVERRIDE; 
...
USE [master]
GO
EXEC xp_instance_regwrite N'HKEY_LOCAL_MACHINE', N'Software\Microsoft\MSSQLServer\MSSQLServer', N'DefaultData', REG_SZ, N'D:\MSSQL$SQL2012_2\Data'
GO
EXEC xp_instance_regwrite N'HKEY_LOCAL_MACHINE', N'Software\Microsoft\MSSQLServer\MSSQLServer', N'DefaultLog', REG_SZ, N'D:\MSSQL$SQL2012_2\Log'
GO
EXEC xp_instance_regwrite N'HKEY_LOCAL_MACHINE', N'Software\Microsoft\MSSQLServer\MSSQLServer', N'BackupDirectory', REG_SZ, N'D:\MSSQL$SQL2012_2\Backup'
GO
...
ALTER DATABASE tempdb MODIFY FILE ( NAME = tempdev , FILENAME = 'E:\MSSQL$SQL2014_2\TempDB\Data\tempdb.mdf' );
ALTER DATABASE tempdb MODIFY FILE ( NAME = templog , FILENAME = 'E:\MSSQL$SQL2014_2\TempDB\Log\templog.ldf' );
...
-- Add new data files
alter database tempdb add file (name = tempdb_data2, filename = 'D:\MSSQL$DIAGEO\Data\tempdb_data2.ndf',size = 20GB, filegrowth = 2GB);
alter database tempdb add file (name = tempdb_data3, filename = 'D:\MSSQL$DIAGEO\Data\tempdb_data3.ndf',size = 20GB, filegrowth = 2GB);
